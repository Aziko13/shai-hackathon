        ...
        try:
            ...
            if re.match(r"^https?://", path, flags=re.I):
                await context.bot.send_photo(
                    chat_id=chat_id, photo=path, reply_to_message_id=reply_to_msg_id
                )
            else:
                ...
                with open(path, "rb") as f:
                    await context.bot.send_photo(
                        chat_id=chat_id, photo=f, reply_to_message_id=reply_to_msg_id
                    )
            ...
            await context.bot.send_message(
                chat_id=chat_id, text=f"Не удалось отправить изображение: {fname}"
            )
    ...
    try:
        ...
        if images:
            await send_images(
                ...
                images,
                context,
                reply_to_msg_id=sent.message_id,
            )
